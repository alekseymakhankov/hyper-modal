...
import { buildContentStyle, classnames, createElement, defaultProps, defferCall } from './helpers'
...
export const HyperModal: React.FC<IModalProps> = ({
    ...
    const renderModalContent = React.useCallback(() => {
        ...
        return (
            ...
            >
                {content || (
                    <DefaultModalContent ariaProps={ariaProps} ariaEnabled={ariaEnabled} handleClose={handleClose} />
                )}
                {renderCloseIcon({
                    classes,
    ...
    }, [classes, isInnerOpen, portalMode, portalNode, renderModalWrapper, unmountOnClose])
